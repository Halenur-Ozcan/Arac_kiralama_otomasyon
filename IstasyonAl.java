...
public class IstasyonAl extends Istasyon{     // istasyon ata sınıfından kalıtım alınır
	...
	public IstasyonAl(String sehir, String istasyon) {
...
Scanner sc = new Scanner(System.in);
     ...
     public void ist() {	// override işlemi yapılır
    	 ...
    	 System.out.println("Aracı teslim almak istediğiniz şehiri seçiniz...");
		 ...
		 if(sec==1) {
    	    ...
    	    System.out.println("İstasyon seçiniz..");
    	    s=sc.nextInt();
			if(s == 1 || s == 2 || s == 3 ){
